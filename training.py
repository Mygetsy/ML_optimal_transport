...
def main(DATASET1_NAME_ADRESS, DATASET2_NAME_ADRESS, restart_calculation=False, ITER_NUM=0):
    DEVICE_IDS = [0]

    DATASET1, DATASET1_PATH = DATASET1_NAME_ADRESS
    DATASET2, DATASET2_PATH = DATASET2_NAME_ADRESS
...
if __name__ == '__main__':
    DATASET1_NAME_ADRESS = ('shoes', './shoes_64.hdf5')
    DATASET2_NAME_ADRESS = ('handbag', './handbag_64.hdf5')
    main(DATASET1_NAME_ADRESS, DATASET2_NAME_ADRESS)
